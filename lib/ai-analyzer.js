...
Provide tactical analysis in this JSON format:
{
  ...
  "tactics": {
    "range": "<specific optimal range in km for YOUR SHIP's weapons vs the target>",
    "movement": "<movement strategy for YOUR SHIP based on your propulsion vs theirs>",n    "engagement": "<how to initiate based on YOUR FITTED tackle/EWAR>",
