...
- Examples of ACTIVE modules: Weapons, Shield Boosters, Armor Repairers, Afterburners, Microwarpdrives, Scramblers, Webs, Neutralizers
...
Be specific about actual fitted modules, weapon types, optimal ranges, and ammo choices. This is a real PvP analysis, not generic advice.`;
  ...
  async getModuleClassification(moduleInfo) {
    ...
    const passiveModules = [
      ...
      'reinforcer', 'amplifier', 'booster', 'battery', 'capacitor flux coil',
    ...
    const activeModules = [
      ...
      // Active tank
      'repairer', 'booster', 'shield booster', 'armor repairer', 
