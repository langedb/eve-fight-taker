...
class FitCalculator {
  ...
  isWeaponModule(moduleInfo) {
    ...
    const weaponGroups = [
      53, 55, 74, 76, 394, 507, 771, 524, 26, 27, // Turrets (added 53 for Energy Weapon)
      506, 507, 508, 509, 510, 511, 812, 1245, // Missile launchers (added 506 for Cruise Launcher, 1245 for Rapid Heavy)
      1496, // Other weapon systems
      1986, // Entropic Disintegrators (Triglavian)
  ...
  isMissileLauncher(moduleInfo) {
    ...
    const missileGroups = [
      506, 507, 508, 509, 510, 511, 812, 1245 // Various missile launcher types
    ];
