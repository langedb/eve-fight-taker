  ...
  getWeaponAmmoCompatibility() {
    return {
      ...
      missile: {
        ...
        // Standard missiles: 384 (light), 385 (heavy), 386 (cruise), 387 (rocket), 388 (torpedo)
        // Faction/T2: 389, 390, 392, 648 (advanced rocket), 655, 656
        // Legacy: 84 (citadel missiles)
        ammoGroups: [84, 384, 385, 386, 387, 388, 389, 390, 392, 648, 655, 656]
      }
    };
  }
